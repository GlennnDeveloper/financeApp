...
struct PremiumView: View {
    ...
    var body: some View {
        ZStack {
            PremiumBackground(colors: [.yellow, .black, .indigo])
                    ...
                    VStack(spacing: 16) {
                        ...
                        Button {
                            ...
                            Text(SettingsManager.shared.isPremium ? SettingsManager.shared.localizedString(for: "Premium Active") : SettingsManager.shared.localizedString(for: "Start 7-Day Free Trial"))
                                ...
                                .padding(.vertical, 16)
                                .background(SettingsManager.shared.isPremium ? Color.green : Color.yellow, in: RoundedRectangle(cornerRadius: 16))
                        }
                    }
                    .glassCard(cornerRadius: 24, padding: 24, lowRes: true)
                    .padding(.horizontal)
                    .padding(.bottom, 40)
                }
            }
